        ...
        <View style={styles.header}>
          ...
          >
            <View
              style={[
                styles.apiStatusDot,
                { backgroundColor: hasApiKey ? colors.success : colors.destructive },
              ]}
            />
            <Text
              style={[
              ...
              <View>
                ...
                <Card style={styles.recentErrorsCard}>
                  ...
                  {errorSummary.recent_errors.slice(0, 8).map((err, i) => (
                    <View
                      key={err.id}
                      style={[styles.errorRow, i < errorSummary.recent_errors.length - 1 && styles.errorRowBorder]}
                    >
          ...
          <View>
            ...
            >
              {generatingReport ? (
                ...
                <>
                  <ActivityIndicator color={colors.white} size="small" />
                  <Text style={styles.generateReportBtnText}>Génération des exercices...</Text>
                </>
              ) : (
                <>
                    ...
                    <View style={styles.exerciseItemHeader}>
                      ...
                      <View style={{ flex: 1, marginLeft: 10 }}>
                        ...
                        <Text style={styles.exerciseMeta}>
                          {ex.category} · <Text style={{ color: difficultyColor(ex.difficulty) }}>{ex.difficulty}</Text>
                        </Text>
                      </View>
                      ...
                      <View style={styles.exerciseExpanded}>
                        ...
                        {ex.tips.length > 0 && (
                          <View style={styles.exerciseTipsBox}>
                            ...
                            {ex.tips.map((t, ti) => (
                              <Text key={ti} style={styles.exerciseTipText}>{t}</Text>
                            ))}
                          </View>
                        )}
                      </View>
        ...
        {activeSection === 'settings' && (
          <View>
            ...
            <Card style={styles.modelCard}>
              ...
              <Text style={styles.apiDescription}>
                Tous ces modèles sont gratuits sur AI Studio (1500 req/jour).
                Si vous obtenez une erreur de quota, essayez un autre modèle.
              </Text>
...
const styles = StyleSheet.create({
  ...
  improvText: { fontSize: fontSize.sm, color: colors.text, textTransform: 'capitalize', flex: 1 },
  ...
  reportLevel: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 10, flexWrap: 'wrap' },
  reportLevelLabel: { fontSize: fontSize.sm, color: colors.textMuted },
  reportLevelValue: { fontSize: fontSize.base, fontWeight: '700', color: colors.primary, flexShrink: 1 },
  reportEncouragement: { fontSize: fontSize.sm, color: colors.text, fontStyle: 'italic', lineHeight: 20, borderLeftWidth: 3, borderLeftColor: colors.primary, paddingLeft: 10, flexWrap: 'wrap' },
  ...
  objectiveValue: { fontSize: fontSize.sm, color: colors.text, lineHeight: 20, flexWrap: 'wrap' },
  ...
  apiCancelBtn: { paddingHorizontal: 12, paddingVertical: 10, borderRadius: borderRadius.xl, backgroundColor: `${colors.textMuted}12` },
